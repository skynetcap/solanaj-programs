...
public class ZetaProgram extends Program {
    ...
    private static final byte[] PLACE_PERP_ORDER_SIGHASH = new byte[]{
            (byte) 0x45, (byte) 0xA1, (byte) 0x5D, (byte) 0xCA, (byte) 0x78, (byte) 0x7E, (byte) 0x4C, (byte) 0xB9
    };
    ...
    public static TransactionInstruction placeOrder(PublicKey authority,
        ...
        byte[] transactionData = buildPlaceOrderInstructionData(
                order,
                side,
                orderType
        );
    ...
    public static TransactionInstruction placePerpOrder(PublicKey authority,
                                                        PublicKey state,
                                                        PublicKey zetaGroup,
                                                        PublicKey marginAccount,
                                                        PublicKey serumAuthority,
        ...
        final AccountMeta marketMintMeta = new AccountMeta(marketMint, false, true);
        final AccountMeta mintAuthorityMeta = new AccountMeta(mintAuthority, false, false);
        final AccountMeta perpSyncQueueMeta = new AccountMeta(perpSyncQueue, false, true);
        ...
        byte[] transactionData = buildPerpOrderInstruction(
                order,
                side,
                orderType
        );
    ...
    public static byte[] buildPerpOrderInstruction(Order order, ZetaSide side, ZetaOrderType zetaOrderType) {
        return buildZetaOrderInstruction(PLACE_PERP_ORDER_SIGHASH, order, side, zetaOrderType);
    }

    public static byte[] buildPlaceOrderInstructionData(Order order, ZetaSide side, ZetaOrderType zetaOrderType) {
        return buildZetaOrderInstruction(PLACE_ORDER_SIGHASH, order, side, zetaOrderType);
    }

    public static byte[] buildZetaOrderInstruction(byte[] sigHash,
                                                   Order order,
                                                   ZetaSide side,
                                                   ZetaOrderType orderType) {
